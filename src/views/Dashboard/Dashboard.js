...
const Dashboard = () => {
  ...
  return (
    <div className="animated fadeIn loader-outer">
      ...
      <Row>
        {/* <div className="col-sm-6 col-md-3">
          <Link to={"/super-masters"}>
            <div className="text-white dsboard_box3 card">
              <div className="card-body">
                <div className="h4 text-muted text-right mb-2"><i className="icon-people"></i></div>
                <div className="h1 mb-0">{dashboard.total_active_players > 0 ?dashboard.total_active_players:0}</div>
                <small className="text-muted text-uppercase font-weight-bold">Total Active Players</small>
                <div className="progress-xs mt-3 mb-0 progress-white progress">
                  <div className="progress-bar" role="progressbar" aria-valuenow="25" aria-valuemin="0"
                    aria-valuemax="100" style={{ width: '100%' }}></div>
                </div>
        ...
        <div className="col-sm-6 col-md-3">
          <Link to={"/"}>
            <div className="text-white dsboard_box4 card">
              <div className="card-body">
                <div className="h4 text-muted text-right mb-2"><i className="icon-people"></i></div>
                <div className="h1 mb-0">{dashboard.fantasy_total_contests}</div>
                <small className="text-muted text-uppercase font-weight-bold">Fantasy Total Contest</small>
                <div className="progress-xs mt-3 mb-0 progress-white progress">
                  <div className="progress-bar" role="progressbar" aria-valuenow="25" aria-valuemin="0"
                    aria-valuemax="100" style={{ width: '100%' }}></div>
                </div>
        ...
        <div className="col-sm-6 col-md-3">
          <Link to={"/"}>
            <div className="text-white dsboard_box6 card">
              <div className="card-body">
                <div className="h4 text-muted text-right mb-2"><i className="icon-people"></i></div>
                <div className="h1 mb-0">{dashboard.fantasy_inactive_contests}</div>
                <small className="text-muted text-uppercase font-weight-bold">Fantasy InActive Contest</small>
                <div className="progress-xs mt-3 mb-0 progress-white progress">
                  <div className="progress-bar" role="progressbar" aria-valuenow="25" aria-valuemin="0"
                    aria-valuemax="100" style={{ width: '100%' }}></div>
                </div>
          ...
          <Card>
            <CardBody>
              ...
              <nav className="navbar navbar-expand-lg navbar-light bg-light">
                <Link to='#' className="navbar-brand">Earning Graph</Link>
