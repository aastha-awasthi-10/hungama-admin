      ...
      <Modal isOpen={modal} toggle={e => { setModal(false) }} className={"custom-modal"}>
          ...
          <Row>
            ...
            <Col md={6}>
              <FormGroup>
                ...
                <div><img src={item.pan_image || ''} height="100" width="200" /></div>
              </FormGroup>
            </Col>
        ...
        <ModalFooter>
          {!isUndefined(props.module) && module.edit === 1 ? <>
            {(pan_verified != 'Approved' && pan_verified != 'Declined By Admin') && <button type="button" className="btn btn-success pull-right" data-dismiss="modal" onClick={(e) => { accept(1) }}>Approve</button>}
