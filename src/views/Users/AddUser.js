...
const AddUser = (props) => {
  ...
  const onSubmit = async data => {
    ...
    let postJson = { full_name: data.full_name.trim(), gender: gender, dob: dob, email: data.email, username: _.snakeCase(data.username), phone: data.mobile };
            ...
            <Row>
              ...
              {/* <Col md={6}>
                <FormGroup>
                  ...
                  <input type="text"  minLength={"3"} maxLength={"50"} name="last_name" placeholder="Last Name" autoComplete="off"
                    className="form-control col-md-8" ref={register({ required: 'Required', pattern: /^[A-Za-z]+$/i })} />
              ...
              <Col md={6}>
                <FormGroup>
                  ...
                  <input type="text" minLength={"3"} maxLength={"50"} name="username" id={"username"} className="form-control col-md-8" autoComplete="off" placeholder="User Name"
              ...
              <Col md={6}>
                <FormGroup>
                  ...
                  <input type="number" min={0} name="mobile" className="form-control  col-md-8" maxLength="10" placeholder="Mobile Number"
                    ref={register({
