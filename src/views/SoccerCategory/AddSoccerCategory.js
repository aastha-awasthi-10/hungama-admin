...
const AddSoccerCategory = (props) => {
  ...
  const onSubmit = async data => {
    ...
    let postJson = { title: data.title.trim(), sequence: data.category_sequence, description: data.description };
    formData.append('data', JSON.stringify(postJson));
    formData.append('cricket_category_pic', profilePic);
    let path = apiUrl.add_soccer_category;
  ...
  return (
    <React.Fragment>
      <form onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data">
        <Card>
          <CardHeader>
            <CardTitle className="text-info"><h4>Add Soccer Category</h4></CardTitle>
          </CardHeader>
          <CardBody>
            <Row>
              <Col md={12}>
              ...
              <Col md={12}>
                <FormGroup>
                  ...
                  <input type="number" name="category_sequence" maxLength={"3"} min={"1"} max={"999"} placeholder="Category Sequence" autoComplete="off"
                    className="form-control col-md-8" ref={register({ required: 'Required' })} />
              ...
              <Col md={12}>
                <FormGroup>
                  ...
                  <textarea name="description" placeholder="Small Description..." autoComplete="off" className="form-control col-md-8" ref={register({ required: 'Required' })}></textarea>
...
export default AddSoccerCategory;
