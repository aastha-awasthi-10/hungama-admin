...
import { Button, Card, CardBody, CardHeader, CardTitle, CardFooter, FormGroup, Label, Col, Form, Row, Table } from 'reactstrap';
                    ...
                    <CardBody>
                        <Row>
                            <Col md={12}>
                                <FormGroup>
                                    <Label>Title</Label>
                                    <TextValidator readOnly type="text" name="title" className="form-control" placeholder="Page Title"
