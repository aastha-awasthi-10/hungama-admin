...
const AddQuiz = (props) => {
  ...
  const onSubmit = async data => {
    ...
    let postJson = {
      ...
      quiz_language: data.quiz_language,
  ...
  return (
    <React.Fragment>
      <form onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data">
        <Card>
          <CardHeader>
            <CardTitle className="text-info"><h4>Add Quiz</h4></CardTitle>
          </CardHeader>
          <CardBody>
            <Row>
              <Col md={6}>
              ...
              <Col md={6}>
                <FormGroup>
                  ...
                  <select name={'quiz_language'} className={"form-control col-md-6"} ref={register({ required: 'Required' })}>
              ...
              <Col md={6}>
                <FormGroup>
                  ...
                  <select name={'quiz_type'} className={"form-control col-md-6"} ref={register({ required: 'Required' })} onChange={(e) => { handleType(e) }}>
              ...
              <Col md={6}>
                <FormGroup>
                  ...
                  <textarea name="quiz_rules" placeholder="Quiz Rules..." autoComplete="off" className="form-control col-md-6" ref={register({ required: 'Required' })}></textarea>
