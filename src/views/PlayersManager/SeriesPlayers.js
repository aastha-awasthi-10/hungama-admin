            ...
            <CardBody>
              <div className="multipal-searching">
                <Row>
                  ...
                  <Col xl={2}>
                       <button className="btn btn-primary mr-1 col-md-5 mb-2" type="button" onClick={getPlayers}><i className="fa fa-search" /> Search{isserach === true && <i className="fa fa-spinner fa-pulse fa-fw ml-1" />}</button>
                         <button className="btn dark_btn col-md-5 mb-2" type="button" onClick={onReset}><i className="fa fa-undo" /> Reset</button>
                  </Col>
                </Row>
              </div>
              <div id="reportId" >
