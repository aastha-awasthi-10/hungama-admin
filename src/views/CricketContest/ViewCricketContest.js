...
const ViewContest = (props) => {
  ...
  const [bonus, setBonus] = useState(props.item.bonus);
  ...
  return (
      ...
      <button className="btn circle_btn btn-sm mr-1" type="button" title="View Details" onClick={(e) => { setModal(true);}}><i class="fa fa-eye"></i></button>
        ...
        <ModalBody>
          <Table hover bordered responsive className="mt-3 text-center">
            ...
            {/* <tr>
                ...
                <td>{props.item.user_id.first_name + "" +props.item.user_id.last_name}</td>
            </tr> */}
            <tr>
