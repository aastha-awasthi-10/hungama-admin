  ...
  return (
    <React.Fragment>
      <form onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data">
        <Card>
          <CardHeader>
            <CardTitle className="text-info"><h4>Add Ads</h4></CardTitle>
          </CardHeader>
          <CardBody>
            <Row>
              <Col md={12}>
              ...
              <Col md={12}>
                <FormGroup>
                  ...
                  <select name={'ads_type'} onChange={handleTypeChange} className={"form-control col-md-6"} ref={register({ required: 'Required' })}>
                ...
                <FormGroup>
                  <Row>
                    ...
                    <div className="col-md-10">
                      <input type="file" onChange={onImageChange} name="ads_pic" className="form-control" autoComplete="off" placeholder="News Image" />
