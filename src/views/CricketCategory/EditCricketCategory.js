...
const EditCricketCategory = (props) => {
  ...
  const onSubmit = async data => {
    ...
    let postJson = { id: id, title: data.title.trim(), sequence: 1, description: data.description };
        ...
        <Card>
          ...
          <CardBody>
            <Row>
              <Col md={12}>
                <FormGroup>
                  <Label className={'col-md-2 pull-left mt-2'}>Cricket Category Title</Label>
              ...
              {/* <Col md={12}>
                <FormGroup>
                  <Label className={'col-md-2 pull-left mt-2'}>Cricket Category Sequence</Label>
              ...
              <Col md={12}>
                <FormGroup>
                  <Label className={'col-md-2 pull-left mt-2'}>Cricket Category Description</Label>
              ...
              {/* <Col md={12}>
                <FormGroup>
                  <Label className={'col-md-2 pull-left mt-2'}>Cricket Category Image</Label>
                  <input type="file" onChange={onImageChange} name="cricket_category_pic" className="form-control  col-md-8" autoComplete="off" placeholder="Cricket Category Image" />
