...
const UpdateFlag = (props) => {
    ...
    const onSubmit = async data => {
        ...
        let path = apiUrl.soccer_update_team_flag;
    ...
    const getData = async () => {
        let path = apiUrl.get_single_soccer_team_data + '/' + props.match.params.id;
    ...
    if(should_redirect) {
        return <Redirect to="/soccer/mst-teams"/>
    }
    return (
        <React.Fragment>
            <form onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data">
                <Card>
                    ...
                    <CardFooter>
                        <Button onClick={setRedirect} color="danger"><i className="fa fa-arrow-left" aria-hidden="true"></i> Back  </Button>
